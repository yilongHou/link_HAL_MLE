...
def create_ci_width_plots(analysis_results, save_dir="experiments/uniform_convergence/plot_density_variance_compare", n_suffix=""):
    ...
    for dgp_name in dgp_names:
        ...
        # Save the plot
        save_path = os.path.join(save_dir, f"v2_CI_Widths_{dgp_name}{n_suffix}.png")
...
def create_coverage_plots(analysis_results, save_dir="experiments/uniform_convergence/plot_density_variance_compare", n_suffix=""):
    ...
    for dgp_name in dgp_names:
        ...
        # Save the plot
        save_path = os.path.join(save_dir, f"v2_Coverage_{dgp_name}{n_suffix}.png")
        plt.savefig(save_path, dpi=300, bbox_inches='tight', pad_inches=0.2)
        print(f"  Saved: {save_path}")
        plt.close()
...
def main():
    ...
    if args.n_only is not None:
        ...
        cache_dir = f"experiments/uniform_convergence/cache_v2_N"
        ...
        cache_dir = "experiments/uniform_convergence/cache_v2"
