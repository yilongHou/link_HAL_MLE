...
def create_ci_width_plots(analysis_results, save_dir="experiments/uniform_convergence/plot_density_variance_compare", n_suffix=""):
    ...
    for dgp_name in dgp_names:
        ...
        # Save the plot
        save_path = os.path.join(save_dir, f"v3_CI_Widths_{dgp_name}{n_suffix}.png")
...
def create_coverage_plots(analysis_results, save_dir="experiments/uniform_convergence/plot_density_variance_compare", n_suffix=""):
    ...
    for dgp_name in dgp_names:
        ...
        # Save the plot
        save_path = os.path.join(save_dir, f"v3_Coverage_{dgp_name}{n_suffix}.png")
        plt.savefig(save_path, dpi=300, bbox_inches='tight', pad_inches=0.2)
        print(f"  Saved: {save_path}")
        plt.close()
...
def save_analysis_results(analysis_results, cache_dir="experiments/uniform_convergence/cache", n_suffix=""):
    ...
    for dgp_name in analysis_results:
        ...
        cache_data = {
            ...
            'computed_at': pd.Timestamp.now().isoformat(),
            'cache_version': '3.0',  # Updated version for v3 structure
    ...
    for dgp_name in dgp_names:
        ...
        try:
            ...
            if cache_version != '3.0':
                print(f"Incompatible cache version {cache_version} for {dgp_name}, expected 3.0")
                continue
...
def main():
    ...
    if args.n_only is not None:
        ...
        cache_dir = f"experiments/uniform_convergence/cache_v3_N"
        ...
        # Use version-specific directories for full analysis
        cache_dir = "experiments/uniform_convergence/cache_v3"
