...
from targeting.base_target_learner import BaseTargetLearner
from targeting.survival.targeting_basis import create_targeting_basis_functions
...
def _compute_survival_from_density(targeted_fit: Dict[str, Any]) -> Tuple[np.ndarray, np.ndarray]:
    ...
    Tuple[np.ndarray, np.ndarray]
        ...
        evaluation points.
    """
    from utils.density_computations import generic_compute_survival_from_density
...
class SurvivalTargetLearner(BaseTargetLearner):
    ...
    def get_b_jk_targeting_full(self, data_grid_full: pd.DataFrame, **kwargs) -> np.ndarray:
        ...
        **kwargs
        ...
        b_jk_targeting_full = basis_grid_tensor_targeting_full.numpy()  # shape: (n_grid_full, n_targeting_basis)
    ...
    def get_estimand_variance(
        ...
        **kwargs
        ...
        b_ik_targeting = basis_tensor.numpy()  # shape: (n_data, n_targeting_points)
